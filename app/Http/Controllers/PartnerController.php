...
class PartnerController extends Controller
{
    public function index()
    {
        ...
        $brokers = $partners->where('partner_type', 'Broker')->count();
        $tpas = $partners->where('partner_type', 'TPA')->count();
        ...
        return view('partnermanagement', ['partners' => $mappedPartners, 'stats' => $stats, 'quickStats' => $quickStats, 'totalPartners' => $totalPartners, 'activities' => $activities]);
    }
