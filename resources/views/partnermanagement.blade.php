                                    ...
                                    <tr>
                                                ...
                                                <div>
                                                    ...
                                                    <ul class="partner-meta-list">
                                                        ...
                                                        <li class="partner-meta-item">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                                viewBox="0 0 14 14" fill="none">
                                                                <path d="M7 1.2C3.8 1.2 1.2 3.8 1.2 7S3.8 12.8 7 12.8 12.8 10.2 12.8 7 10.2 1.2 7 1.2Z"
                                                                    stroke="#9CA3AF"
                                                                    stroke-width="2"/>
                                                            </svg>
                                        ...
                                        <td>
                                            ...
                                            <div class="detail-cell">
                                                ...
                                                {{ Str::limit($partner->address_line1.', '.$partner->city.', '.$partner->country,40) }}
                                        ...
                                        <td>
                                            ...
                                            <span class="status-badge {{ strtolower($partner->status) }}">
                                                {{ $partner->status }}
                                            </span>
                                            ...
                                            <div class="detail-cell">
                                                ...
                                                <span>
                                                    ...
                                                    @if($partner->contract_end)
                                                        ...
                                                        {{ \Carbon\Carbon::parse($partner->contract_end)->format('d M Y') }}
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="text-center py-5">
                                            ...
                                            <p class="text-muted mb-0">
                                                Create your first partner to display it here.
                                            </p>
