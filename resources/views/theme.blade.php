    ...
    <nav class="sidebar id-sidebar" id="sidebar">
      ...
      <div class="py-2">
        ...
        <a href="#" class="sidebar-link">
          ...
          <span>Policy life Cycle Management</span>
        </a>
        <a href="#" class="sidebar-link">
          <i class="bi bi-clipboard"></i>
          <span>Benefits Administration</span>
        </a>
        <span class="sidebar-heading">PolicyAdmin</span>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"
            ...
            <g opacity="0.7" clip-path="url(#clip0_62_4683)">
              <path
                ...
                stroke="white" stroke-opacity="0.6" stroke-width="1.5" />
              <path
                d="M6.75 6.75H6.7575M11.25 6.75H11.2575M7.125 10.5C7.125 10.5 7.875 12 9 12C10.125 12 10.875 10.5 10.875 10.5"
                stroke="white" stroke-opacity="0.6" stroke-width="1.5" />
            </g>
            <defs>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"
            ...
            <g opacity="0.7">
              <path
                ...
                stroke="white" stroke-opacity="0.6" stroke-width="1.5" />
              <path
                d="M14.3024 3.69751C15.7084 5.10397 16.4983 7.01128 16.4983 9.00001C16.4983 10.9887 15.7084 12.8961 14.3024 14.3025M3.69736 3.69751C2.29133 5.10397 1.50146 7.01128 1.50146 9.00001C1.50146 10.9887 2.29133 12.8961 3.69736 14.3025"
                stroke="white" stroke-opacity="0.6" stroke-width="1.5" />
            </g>
          </svg>
